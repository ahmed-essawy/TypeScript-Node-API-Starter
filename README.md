...
13. Profit! If everything worked you should see a page that looks like this: [TypeScript Node API Starter Demo Site](https://typescript-node-starter.azurewebsites.net/)
...
In this project, `bcryptjs.d.ts`, `fbgraph.d.ts`, and `lusca.d.ts` were all generated using `dts-gen`.
